...
namespace Intake.Migrations
{
    ...
    [Migration("20221216063019_sensor_updated")]
    partial class sensor_updated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intake.Models.Process", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intake.Models.Sensor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DraInSensor")
                        .HasColumnType("int");

                    b.Property<string>("MachineSensor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Pump10")
                        .HasColumnType("int");

                    b.Property<int>("Pump5")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intake.Models.Process", b =>
                {
                    b.HasOne("Intake.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Intake.Models.Machine", "Machine")
                        .WithMany()
                        .HasForeignKey("MachineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Intake.Models.Sensor", "Sensor")
                        .WithMany()
